...
with col1:
    ...
    <div class='section'>
        ...
        <p>Upload a brain MRI scan and detect tumor type instantly using VGG16 deep learning with GradCAM visualization.</p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown("""
    <div class='section'>
        ...
        <p>
            ...
            ✅ <b>Deep Learning MRI Analysis:</b> VGG16 CNN with GradCAM for brain tumor detection.<br>
        </p>
    </div>
    """, unsafe_allow_html=True)
